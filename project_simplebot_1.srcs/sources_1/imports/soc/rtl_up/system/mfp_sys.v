...
module mfp_sys(     
                    ...
                    output [`MFP_N_SEG-1:0] IO_7SEGEN_N, // Output for the top level SSEG digit enable pins.
                    output [`MFP_N_SEG-1:0] IO_SEG_N, // Output for the top level segment and decimal point enable pins.
                    input                   UART_RX);
